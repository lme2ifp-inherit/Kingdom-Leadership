...
// Pure logic only — no network, no database. Run from the repo root: node scripts/verify_drain.js
...
const ai = require(ROOT + "/api/ai.js")._internal;
const drain = require(ROOT + "/api/drain.js")._internal;
...
console.log("\n── ceiling safety ──");
const vercelJson = JSON.parse(require("fs").readFileSync(ROOT + "/vercel.json", "utf8"));
