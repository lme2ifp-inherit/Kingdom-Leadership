...
// against simulated platform responses. Run from the repo root: node scripts/verify_frontend.js
...
(async () => {
  ...
  const vercelJson = JSON.parse(fs.readFileSync(ROOT + "/vercel.json", "utf8"));
